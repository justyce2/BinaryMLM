...
$this->title = ucwords($model->first_name.' '.$model->last_name);
        ...
        <div class="card">
            <div class="card-header">
                <strong><?= Html::encode($this->title) ?></strong>
                 ...
                 <?= Html::a('Login', ['login','id' => $model->user_id,'header' => 'Action'], ['class' => 'btn btn-sm btn-rounded btn-warning pull-right']) ?>
            ...
            <div class="card-body">
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute' => 'bankname',
                            'value' => function($data) { return ($data->bankname) ? $data->bankname : '---'; },
                            'visible' => !Yii::$app->request->get('ajax'),
                        ],
                        [
                            'attribute' => 'accountname',
                            'value' => function($data) { return ($data->accountname) ? $data->accountname : '---'; },
                            'visible' => !Yii::$app->request->get('ajax'),
                        ],
                        [
                            'attribute' => 'accountno',
                            'value' => function($data) { return ($data->accountno) ? $data->accountno : '---'; },
                            'visible' => !Yii::$app->request->get('ajax'),
                        ],
                        'created_at:datetime',
                        'updated_at:datetime',
